...
echo "  3. Once validation is green, invoke initial-install to orchestrate the"
echo "     remaining phases (tool install, MCP activation, scheduled tasks,"
echo "     per-device config, voice customization, engagement bootstrap,"
echo "     final validation). The orchestrator persists progress to"
echo "     .claude/_install-state/state.json so you can pause and resume."
echo ""
echo "Documentation:"
...
echo "  Orchestrator:     Universal/FOLLOW-workflows-and-guides/playbooks/initial-install.md"
echo ""
